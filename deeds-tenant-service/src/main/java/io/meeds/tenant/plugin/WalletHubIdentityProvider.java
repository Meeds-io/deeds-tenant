...
public class WalletHubIdentityProvider extends IdentityProvider<String> {
  ...
  public static final String PROVIDER_NAME   = "WALLET_HUB";
  ...
  public static final String CITY            = "HUB_CITY";
  ...
  public static final String MANAGER_ADDRESS = "HUB_MANAGER_ADDRESS";
  ...
  public Identity createIdentity(String remoteId) {
    return new Identity(PROVIDER_NAME, remoteId);
  }
